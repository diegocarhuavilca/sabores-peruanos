        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <template v-for="navItem in navItems" :key="navItem.title">
                    <a :href="navItem.url" class="text-sm/6 font-semibold text-gray-900 hover:text-gray-900/80">{{
                        navItem.title }}</a>
                </template>
            </div>
        </nav>
...
const navItems: Ref<IHeaderNavItem[]> = ref([
    { title: t("navbar.recipes"), url: "#" },
    { title: t("navbar.tips"), url: "#" },
]);
